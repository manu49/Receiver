...
##Buttons
set_property PACKAGE_PIN U18 [get_ports state_override]						
	set_property IOSTANDARD LVCMOS33 [get_ports state_override]
...
##Sch name = JB2
#set_property PACKAGE_PIN A16 [get_ports {serial_data_in}]					
...
##Quad SPI Flash
##Note that CCLK_0 canodenot be placed in 7 series devices. You canode access it using the
##STARTUPE2 primitive.
